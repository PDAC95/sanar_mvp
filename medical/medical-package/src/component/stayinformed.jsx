                ...
                <div className="container">
                    ...
                    <div className="row g-20">
                        <div className="col-lg-4 wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.8s">
                            <div className="dz-card style-2 dz-card-overlay overlay-none" style={{ backgroundImage: `url(${IMAGES.blogoverlay1})` }}>
                                <div className="dz-info">
                                    ...
                                    <div className="bottom-info">
                                        <Link to="/blog-details" className="btn btn-icon btn-lg btn-primary btn-shadow"> Read More
                                            <span className="right-icon"><i className="feather icon-arrow-right" /></span>
                                        </Link>
                                    </div>
                                </div>
                        ...
                        <div className="col-xl-5 col-lg-8 wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.8s">
                            <div className="dz-card style-2 dz-card-overlay" style={{ backgroundImage: `url(${IMAGES.blogoverlaylarge1})` }}>
                                <div className="dz-info">
                                    <div className="post-date">12 Jan 2025</div>
                                    <div className="bottom-info">
                                        <h3 className="dz-title"> <Link to="/blog-details">The Art of Managing Business and Patient Care</Link> </h3>
                                        <Link to="/blog-details" className="btn btn-square btn-white rounded-circle">
                            ...
                            <div className="row g-20">
                                <div className="col-xl-12 col-md-6 wow fadeInUp" data-wow-delay="0.6s" data-wow-duration="0.8s">
                                    <div className="dz-card style-2 dz-card-overlay card-sm no-image">
                                        <div className="dz-info">
                                            <div className="post-date">12 Jan 2025</div>
                                            <h3 className="dz-title"> <Link to="/blog-details">Strategies for Balancing Business Demands with Optimal</Link> </h3>
                                ...
                                <div className="col-xl-12 col-md-6 wow fadeInUp" data-wow-delay="0.8s" data-wow-duration="0.8s">
                                    <div className="dz-card style-2 dz-card-overlay card-sm" style={{ backgroundImage: `url(${IMAGES.blogoverlaysmall1})` }}>
                                        <div className="dz-info">
                                            <div className="post-date">12 Jan 2025</div>
                                            <div className="bottom-info">
                                                <h3 className="dz-title"> <Link to="/blog-details">Effective Healthcare Tips</Link> </h3>
                                                <Link to="/blog-details" className="btn btn-square btn-white rounded-circle">
                                                    <i className="feather icon-arrow-up-right" />
                                                </Link>
                                            </div>
