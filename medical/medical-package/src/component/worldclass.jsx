            ...
            <div className="row content-wrapper style-1 align-items-center">
                            ...
                            <div className="info-widget style-7">
                                ...
                                <div className="widget-media">
                                    ...
                                    <div className="call-widget">
                                        <Link to={"#"}> <img src={IMAGES.camerasvg} alt="" /> </Link>
                                        <Link to={"#"}> <img src={IMAGES.massagesvg} alt="" /> </Link>
                                        <Link to={"#"} className="active"> <img src={IMAGES.callsvg} alt="" /> </Link>
                                        <Link to={"#"}> <img src={IMAGES.mikesvg} alt="" /> </Link>
                                        <Link to={"#"}> <img src={IMAGES.videosvg} alt="" /> </Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="col-xl-6 m-b30">
                    ...
                    <div className="d-flex flex-wrap align-items-center wow fadeInUp" data-wow-delay="0.8s" data-wow-duration="0.8s">
                        <Link to="/appointment" className="btn btn-lg btn-icon btn-secondary btn-shadow m-r30 mb-3 mb-sm-0">
                            Appointment
