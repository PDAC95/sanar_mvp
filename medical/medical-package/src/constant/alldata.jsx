...
export const headerinfo = [
    { image: IMAGES.svgicon1, title: 'Contatc Us', paragraph: <Link to="tel:+11234567890" className="text-secondary">+1 123 456 7890</Link>, },
    { image: IMAGES.svgicon2, title: 'Email Supports', paragraph: <Link to="mailto:email@domain.com" className="text-secondary">email@domain.com</Link>, },
...
export const footerdata1 = [
    { delay: '0.4s', icon: <i className="feather icon-phone" />, title: 'Call Us', paragraph: <Link to="tel:+11234567890" className="text-body">+1 123 456 7890</Link>, },
    { delay: '0.6s', icon: <i className="feather icon-mail" />, title: 'Send us a Mail', paragraph: <Link to="mailto:info@example.com" className="text-body">info@example.com</Link>, },
...
export const countupdata = [
    { title: 'Specialists', delay: '0.4s', countup: <CountUp end={200} duration={5} />, span: '+', },
    { title: 'Happy Patients', delay: '0.6s', countup: <CountUp end={45} duration={5} />, span: 'k', },
    { title: 'Winning Awards', delay: '0.8s', countup: <CountUp end={150} duration={5} />, span: '+', },
]
// frequently 
...
export const mapdata = [
    ...
    { id: 2, delay: '0.4s', icon: <i className="feather icon-phone" />, title: "Call Us", para: <p><Link to="tel:+11234567890">+1 123 456 7890</Link></p>, },
    { id: 3, delay: '0.6s', icon: <i className="feather icon-mail" />, title: "Send us a Mail", para: <p><Link to="mailto:info@example.com">email@domain.com</Link></p>, },
...
export const pricingdata2 = [
    {
        ...
        feature: <ul className="pricingtable-features">
            <li><img src={IMAGES.Check} alt="" /></li>
            <li><img src={IMAGES.Check} alt="" /></li>
            <li><img src={IMAGES.Check} alt="" /></li>
            <li className="disable"><img src={IMAGES.Check} alt="" /></li>
            <li className="disable"><img src={IMAGES.Check} alt="" /></li>
            <li className="disable"><img src={IMAGES.Check} alt="" /></li>
            <li className="disable"><img src={IMAGES.Check} alt="" /></li>
            <li className="disable"><img src={IMAGES.Check} alt="" /></li>
