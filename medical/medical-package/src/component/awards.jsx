                    ...
                    <div className="row g-0 align-items-center">
                        <div className="col-xxl-3">
                            ...
                            {awarddata.map((item, i) => (
                                <Link to={"#"} className="btn btn-outline-light btn-rounded m-r5 m-b10 wow fadeInUp" data-wow-delay={item.delay} data-wow-duration="0.8s" key={i}>{item.title}</Link>
                            ))}
                        </div>
                                    ...
                                    <SwiperSlide key={i}>
                                        <div className="dz-img-box style-1 box-lg grid-bx text-center">
                                            ...
                                            <div className="dz-content">
                                                ...
                                                <Link to={"#"} className="btn-link">Save the Childern</Link>
                                            </div>
                                        </div>
                                    </SwiperSlide>
                                ))}
